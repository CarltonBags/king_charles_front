...
import pub_beer_003 from "./pub_beer_116.json";
      ...
      <div className="w-full max-w-2xl mx-auto p-3">
        <div className="flex flex-col overflow-hidden" style={{ border: "2px solid #f0f0e0", boxShadow: "0 0 0 2px #020201, 0 0 0 4px #f0f0e0", backgroundColor: "#0d0d0f", minHeight: "100vh" }}>
          <header className="flex items-center justify-center" style={{ backgroundColor: "#020201" }}>
            <img src="/images/HEADER.png" alt="The Londoner Drink Guide" onClick={() => router.push("/drink-guide")} className="w-full max-w-[180px] h-auto object-contain mx-auto cursor-pointer" style={{ imageRendering: "pixelated" }} />
          </header>
