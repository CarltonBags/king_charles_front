    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 mt-2">
          <div className="flex-1" style={{ height: "8px", backgroundColor: "#151518", border: "1px solid #606068" }}>
            <div style={{ height: "100%", width: `${pct}%`, backgroundColor: isTop ? "#5cc8d0" : "#e8b830", transition: "width 0.5s ease" }} />
          </div>
          <span style={{ fontFamily: "'Jersey 10', monospace", fontSize: "16px", color: "#808090" }}>{pct}% MATCH</span>
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden" style={{ border: "2px solid #f0f0e0", boxShadow: "0 0 0 2px #020201, 0 0 0 4px #f0f0e0", backgroundColor: "#0d0d0f" }}>
          ...
          <div className="flex-1 overflow-y-auto chat-scroll p-4" style={{ backgroundColor: "#020201" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              ...
              <div className="flex justify-center animate-fade-in-up" style={{ paddingBottom: "48px" }}>
